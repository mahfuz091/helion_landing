...
import EtherumEdgePriceBar from "@/Components/Charts/EtherumEdgeVaultChart/EtherumEdgePriceBar";
...
const EtherumVault = () => {
  ...
  const fetchPerformData = async (period) => {
...
`;
  ...
  const fetchVaultData = async () => {
    ...
    try {
      ...
      console.log(performanceMetrics.day);
    ...
    <div className='vaults'>
      <div className='d-flex justify-content-between'>
        ...
        <div>
          <Link
            target='_blank'
            href='https://dhedge.org/vault/0xdccc9d73ca87fe6569ea74c4e7555f13dce61da2'
          >
      ...
      <Tab.Container id='left-tabs-example' defaultActiveKey='priceYear'>
        ...
        <Tab.Content>
          ...
          <Tab.Pane eventKey='priceWeek'>
            {chartBar ? (
              <EtherumEdgePriceBar period='1w' interval='4h' />
            ) : (
          ...
          <Tab.Pane eventKey='priceMonth'>
            {chartBar ? (
              <EtherumEdgePriceBar period='1m' interval='1d' />
            ) : (
          ...
          <Tab.Pane eventKey='priceYear'>
            {chartBar ? (
              <EtherumEdgePriceBar period='1y' interval='1w' />
            ) : (
