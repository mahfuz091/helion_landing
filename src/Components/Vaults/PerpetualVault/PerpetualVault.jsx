...
import PerpetualPriceBar from "@/Components/Charts/PerpetualVault/PerpetualPriceBar";
      ...
      <Tab.Container id='left-tabs-example' defaultActiveKey='priceYear'>
        ...
        <Tab.Content>
          <Tab.Pane eventKey='priceDay'>
            {chartBar ? (
              <PerpetualPriceBar period='1d' interval='1h' />
            ) : (
              <PerpetualPriceDay />
            )}
          </Tab.Pane>
          <Tab.Pane eventKey='priceWeek'>
            {chartBar ? (
              <PerpetualPriceBar period='1w' interval='4h' />
            ) : (
              <PerpetualPriceWeek />
            )}
          </Tab.Pane>
          <Tab.Pane eventKey='priceMonth'>
            {chartBar ? (
              <PerpetualPriceBar period='1m' interval='1d' />
            ) : (
              <PerpetualPriceMonth />
            )}
          </Tab.Pane>
          <Tab.Pane eventKey='priceYear'>
            {chartBar ? (
              <PerpetualPriceBar period='1y' interval='1w' />
            ) : (
              <PerpetualPriceYear />
            )}
          </Tab.Pane>
