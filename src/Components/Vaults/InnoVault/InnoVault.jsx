...
import InnoPriceMonth from "@/Components/Charts/InnoVaultChart/InnoPriceMonth";
      ...
      <Tab.Container id='left-tabs-example' defaultActiveKey='priceYear'>
        ...
        <Tab.Content>
          <Tab.Pane eventKey='priceDay'>
            {chartBar ? (
              <InnoPriceBar period='1d' interval='1h' />
            ) : (
              <InnoPriceDay />
            )}
          </Tab.Pane>
          <Tab.Pane eventKey='priceWeek'>
            {chartBar ? (
              <InnoPriceBar period='1w' interval='4h' />
            ) : (
              <InnoPriceWeek />
            )}
          </Tab.Pane>
          <Tab.Pane eventKey='priceMonth'>
            {chartBar ? (
              <InnoPriceBar period='1m' interval='1d' />
            ) : (
              <InnoPriceMonth />
            )}
          </Tab.Pane>
          <Tab.Pane eventKey='priceYear'>
            {chartBar ? (
              <InnoPriceBar period='1y' interval='1w' />
            ) : (
              <InnoPriceYear />
            )}
          </Tab.Pane>
          ...
          <Tab.Pane eventKey='apyYear'>
            <InnoVaultApyYear></InnoVaultApyYear>
          </Tab.Pane>
        </Tab.Content>
      </Tab.Container>
    </div>
